...
**Cybersecurity Engineer in Training** · CompTIA Security+ · KIIT B.Tech CSE '27  
`SIEM` · `Cloud Security` · `Threat Detection` · `Incident Response`

---

## What I Build & Break

I focus on **defensive security** — building detection infrastructure, simulating real-world attacks, and closing the gap between theory and production-grade SOC work.
...
| Offensive | Burp Suite, Metasploit, Nmap, OWASP Top 10 |
...
[![TryHackMe](https://img.shields.io/badge/TryHackMe-Hackermaan-212C42?style=flat-square&logo=tryhackme&logoColor=red)](https://tryhackme.com/p/Hackermaan)
